...
// npm deliberately omits package-lock.json and .gitignore from installed Git
// packages. Excluding them here and from the container context keeps the image
// identity stable between an authoring checkout and its immutable release.
const EXCLUDED_NAMES = new Set([".git", ".gitignore", "node_modules", "package-lock.json"]);
